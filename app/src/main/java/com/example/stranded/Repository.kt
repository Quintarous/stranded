...
class Repository @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    suspend fun insertTestPromptLines() {
        val list = listOf(
            ...
            PromptLine(0, 1, 1, "goes to prompt set 4 and triggers one and done animation", 4),
    ...
    suspend fun insertTestTriggers() {
        val list = mutableListOf<Trigger>(
            ...
            Trigger(0, 1, 3, "prompt", "animation", R.drawable.g_meter_up_animation, loop = false, oneAndDone = true),
