...
class Repository @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    fun getTriggerList1(): List<Trigger> {
        return mutableListOf(
            ...
            Trigger(0, 6, 38, "script", "animation", R.drawable.g_down_small_animation),
            Trigger(0, 6, 59, "script", "animation", R.drawable.g_wobble_animation, oneAndDone = true),
            Trigger(0, 6, 65, "script", "animation", R.drawable.g_meter_up_animation, oneAndDone = true),
            Trigger(0, 6, 82, "script", "animation", R.drawable.g_walk_animation, true),
